...
#define PMC_SCER_QSPICLK(value)               (PMC_SCER_QSPICLK_Msk & (_UINT32_(value) << PMC_SCER_QSPICLK_Pos)) /* Assignment of value for QSPICLK in the PMC_SCER register */
...
#define PMC_SCDR_QSPICLK(value)               (PMC_SCDR_QSPICLK_Msk & (_UINT32_(value) << PMC_SCDR_QSPICLK_Pos)) /* Assignment of value for QSPICLK in the PMC_SCDR register */
...
#define PMC_SCSR_QSPICLK(value)               (PMC_SCSR_QSPICLK_Msk & (_UINT32_(value) << PMC_SCSR_QSPICLK_Pos)) /* Assignment of value for QSPICLK in the PMC_SCSR register */
...
#define PMC_PLL_UPDT_STUPTIM_Msk              (_UINT32_(0x3F) << PMC_PLL_UPDT_STUPTIM_Pos)         /* (PMC_PLL_UPDT) Startup Time Mask */
...
#define PMC_PLL_UPDT_Msk                      _UINT32_(0x003F0101)                                 /* (PMC_PLL_UPDT) Register Mask  */
...
#define PMC_CSR1_Msk                          _UINT32_(0x0003BFFF)                                 /* (PMC_CSR1) Register Mask  */

#define PMC_CSR1_PID_Pos                      _UINT32_(0)                                          /* (PMC_CSR1 Position) Peripheral Clock 49 Status */
#define PMC_CSR1_PID_Msk                      (_UINT32_(0x1FFFF) << PMC_CSR1_PID_Pos)              /* (PMC_CSR1 Mask) PID */
...
#define PMC_PLL_ISR1_UDRA(value)              (PMC_PLL_ISR1_UDRA_Msk & (_UINT32_(value) << PMC_PLL_ISR1_UDRA_Pos)) /* Assignment of value for UDRA in the PMC_PLL_ISR1 register */
...
#define PMC_PLL_ISR1_UDRU(value)              (PMC_PLL_ISR1_UDRU_Msk & (_UINT32_(value) << PMC_PLL_ISR1_UDRU_Pos)) /* Assignment of value for UDRU in the PMC_PLL_ISR1 register */
...
#define PMC_PLL_ISR1_OVRA(value)              (PMC_PLL_ISR1_OVRA_Msk & (_UINT32_(value) << PMC_PLL_ISR1_OVRA_Pos)) /* Assignment of value for OVRA in the PMC_PLL_ISR1 register */
...
#define PMC_PLL_ISR1_OVRU(value)              (PMC_PLL_ISR1_OVRU_Msk & (_UINT32_(value) << PMC_PLL_ISR1_OVRU_Pos)) /* Assignment of value for OVRU in the PMC_PLL_ISR1 register */
