...
#define SFR_CCFG_EBICSA_EBI_CS3A(value)       (SFR_CCFG_EBICSA_EBI_CS3A_Msk & (_UINT32_(value) << SFR_CCFG_EBICSA_EBI_CS3A_Pos)) /* Assignment of value for EBI_CS3A in the SFR_CCFG_EBICSA register */
...
#define SFR_CCFG_EBICSA_EBI_CS4A(value)       (SFR_CCFG_EBICSA_EBI_CS4A_Msk & (_UINT32_(value) << SFR_CCFG_EBICSA_EBI_CS4A_Pos)) /* Assignment of value for EBI_CS4A in the SFR_CCFG_EBICSA register */
...
#define SFR_CCFG_EBICSA_EBI_CS5A(value)       (SFR_CCFG_EBICSA_EBI_CS5A_Msk & (_UINT32_(value) << SFR_CCFG_EBICSA_EBI_CS5A_Pos)) /* Assignment of value for EBI_CS5A in the SFR_CCFG_EBICSA register */
...
#define SFR_CCFG_EBICSA_EBI_DRIVE(value)      (SFR_CCFG_EBICSA_EBI_DRIVE_Msk & (_UINT32_(value) << SFR_CCFG_EBICSA_EBI_DRIVE_Pos)) /* Assignment of value for EBI_DRIVE in the SFR_CCFG_EBICSA register */
