...
#define SMC_OCMS_CS4SE(value)                 (SMC_OCMS_CS4SE_Msk & (_UINT32_(value) << SMC_OCMS_CS4SE_Pos)) /* Assignment of value for CS4SE in the SMC_OCMS register */
...
#define SMC_OCMS_CS5SE(value)                 (SMC_OCMS_CS5SE_Msk & (_UINT32_(value) << SMC_OCMS_CS5SE_Pos)) /* Assignment of value for CS5SE in the SMC_OCMS register */
