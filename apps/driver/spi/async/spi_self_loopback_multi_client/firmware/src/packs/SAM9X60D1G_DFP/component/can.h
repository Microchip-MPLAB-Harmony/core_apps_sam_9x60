...
#define CAN_MMR_MTIMEMARK(value)              (CAN_MMR_MTIMEMARK_Msk & (_UINT32_(value) << CAN_MMR_MTIMEMARK_Pos)) /* Assignment of value for MTIMEMARK in the CAN_MMR register */
...
#define CAN_MMR_PRIOR(value)                  (CAN_MMR_PRIOR_Msk & (_UINT32_(value) << CAN_MMR_PRIOR_Pos)) /* Assignment of value for PRIOR in the CAN_MMR register */
...
#define CAN_MMR_MOT(value)                    (CAN_MMR_MOT_Msk & (_UINT32_(value) << CAN_MMR_MOT_Pos)) /* Assignment of value for MOT in the CAN_MMR register */
...
#define CAN_MAM_MIDvB(value)                  (CAN_MAM_MIDvB_Msk & (_UINT32_(value) << CAN_MAM_MIDvB_Pos)) /* Assignment of value for MIDvB in the CAN_MAM register */
...
#define CAN_MAM_MIDvA(value)                  (CAN_MAM_MIDvA_Msk & (_UINT32_(value) << CAN_MAM_MIDvA_Pos)) /* Assignment of value for MIDvA in the CAN_MAM register */
...
#define CAN_MAM_MIDE(value)                   (CAN_MAM_MIDE_Msk & (_UINT32_(value) << CAN_MAM_MIDE_Pos)) /* Assignment of value for MIDE in the CAN_MAM register */
...
#define CAN_MID_MIDvB(value)                  (CAN_MID_MIDvB_Msk & (_UINT32_(value) << CAN_MID_MIDvB_Pos)) /* Assignment of value for MIDvB in the CAN_MID register */
...
#define CAN_MID_MIDvA(value)                  (CAN_MID_MIDvA_Msk & (_UINT32_(value) << CAN_MID_MIDvA_Pos)) /* Assignment of value for MIDvA in the CAN_MID register */
...
#define CAN_MID_MIDE(value)                   (CAN_MID_MIDE_Msk & (_UINT32_(value) << CAN_MID_MIDE_Pos)) /* Assignment of value for MIDE in the CAN_MID register */
...
#define CAN_MFID_MFID(value)                  (CAN_MFID_MFID_Msk & (_UINT32_(value) << CAN_MFID_MFID_Pos)) /* Assignment of value for MFID in the CAN_MFID register */
...
#define CAN_MSR_MTIMESTAMP(value)             (CAN_MSR_MTIMESTAMP_Msk & (_UINT32_(value) << CAN_MSR_MTIMESTAMP_Pos)) /* Assignment of value for MTIMESTAMP in the CAN_MSR register */
...
#define CAN_MSR_MDLC(value)                   (CAN_MSR_MDLC_Msk & (_UINT32_(value) << CAN_MSR_MDLC_Pos)) /* Assignment of value for MDLC in the CAN_MSR register */
...
#define CAN_MSR_MRTR(value)                   (CAN_MSR_MRTR_Msk & (_UINT32_(value) << CAN_MSR_MRTR_Pos)) /* Assignment of value for MRTR in the CAN_MSR register */
...
#define CAN_MSR_MABT(value)                   (CAN_MSR_MABT_Msk & (_UINT32_(value) << CAN_MSR_MABT_Pos)) /* Assignment of value for MABT in the CAN_MSR register */
...
#define CAN_MSR_MRDY(value)                   (CAN_MSR_MRDY_Msk & (_UINT32_(value) << CAN_MSR_MRDY_Pos)) /* Assignment of value for MRDY in the CAN_MSR register */
...
#define CAN_MSR_MMI(value)                    (CAN_MSR_MMI_Msk & (_UINT32_(value) << CAN_MSR_MMI_Pos)) /* Assignment of value for MMI in the CAN_MSR register */
...
#define CAN_MDL_MDL(value)                    (CAN_MDL_MDL_Msk & (_UINT32_(value) << CAN_MDL_MDL_Pos)) /* Assignment of value for MDL in the CAN_MDL register */
...
#define CAN_MDH_MDH(value)                    (CAN_MDH_MDH_Msk & (_UINT32_(value) << CAN_MDH_MDH_Pos)) /* Assignment of value for MDH in the CAN_MDH register */
...
#define CAN_MCR_MDLC(value)                   (CAN_MCR_MDLC_Msk & (_UINT32_(value) << CAN_MCR_MDLC_Pos)) /* Assignment of value for MDLC in the CAN_MCR register */
...
#define CAN_MCR_MRTR(value)                   (CAN_MCR_MRTR_Msk & (_UINT32_(value) << CAN_MCR_MRTR_Pos)) /* Assignment of value for MRTR in the CAN_MCR register */
...
#define CAN_MCR_MACR(value)                   (CAN_MCR_MACR_Msk & (_UINT32_(value) << CAN_MCR_MACR_Pos)) /* Assignment of value for MACR in the CAN_MCR register */
...
#define CAN_MCR_MTCR(value)                   (CAN_MCR_MTCR_Msk & (_UINT32_(value) << CAN_MCR_MTCR_Pos)) /* Assignment of value for MTCR in the CAN_MCR register */
...
#define CAN_MR_CANEN(value)                   (CAN_MR_CANEN_Msk & (_UINT32_(value) << CAN_MR_CANEN_Pos)) /* Assignment of value for CANEN in the CAN_MR register */
...
#define CAN_MR_LPM(value)                     (CAN_MR_LPM_Msk & (_UINT32_(value) << CAN_MR_LPM_Pos)) /* Assignment of value for LPM in the CAN_MR register */
...
#define CAN_MR_ABM(value)                     (CAN_MR_ABM_Msk & (_UINT32_(value) << CAN_MR_ABM_Pos)) /* Assignment of value for ABM in the CAN_MR register */
...
#define CAN_MR_OVL(value)                     (CAN_MR_OVL_Msk & (_UINT32_(value) << CAN_MR_OVL_Pos)) /* Assignment of value for OVL in the CAN_MR register */
...
#define CAN_MR_TEOF(value)                    (CAN_MR_TEOF_Msk & (_UINT32_(value) << CAN_MR_TEOF_Pos)) /* Assignment of value for TEOF in the CAN_MR register */
...
#define CAN_MR_TTM(value)                     (CAN_MR_TTM_Msk & (_UINT32_(value) << CAN_MR_TTM_Pos)) /* Assignment of value for TTM in the CAN_MR register */
...
#define CAN_MR_TIMFRZ(value)                  (CAN_MR_TIMFRZ_Msk & (_UINT32_(value) << CAN_MR_TIMFRZ_Pos)) /* Assignment of value for TIMFRZ in the CAN_MR register */
...
#define CAN_MR_DRPT(value)                    (CAN_MR_DRPT_Msk & (_UINT32_(value) << CAN_MR_DRPT_Pos)) /* Assignment of value for DRPT in the CAN_MR register */
...
#define CAN_MR_RXSYNC(value)                  (CAN_MR_RXSYNC_Msk & (_UINT32_(value) << CAN_MR_RXSYNC_Pos)) /* Assignment of value for RXSYNC in the CAN_MR register */
...
#define CAN_IER_MB0(value)                    (CAN_IER_MB0_Msk & (_UINT32_(value) << CAN_IER_MB0_Pos)) /* Assignment of value for MB0 in the CAN_IER register */
...
#define CAN_IER_MB1(value)                    (CAN_IER_MB1_Msk & (_UINT32_(value) << CAN_IER_MB1_Pos)) /* Assignment of value for MB1 in the CAN_IER register */
...
#define CAN_IER_MB2(value)                    (CAN_IER_MB2_Msk & (_UINT32_(value) << CAN_IER_MB2_Pos)) /* Assignment of value for MB2 in the CAN_IER register */
...
#define CAN_IER_MB3(value)                    (CAN_IER_MB3_Msk & (_UINT32_(value) << CAN_IER_MB3_Pos)) /* Assignment of value for MB3 in the CAN_IER register */
...
#define CAN_IER_MB4(value)                    (CAN_IER_MB4_Msk & (_UINT32_(value) << CAN_IER_MB4_Pos)) /* Assignment of value for MB4 in the CAN_IER register */
...
#define CAN_IER_MB5(value)                    (CAN_IER_MB5_Msk & (_UINT32_(value) << CAN_IER_MB5_Pos)) /* Assignment of value for MB5 in the CAN_IER register */
...
#define CAN_IER_MB6(value)                    (CAN_IER_MB6_Msk & (_UINT32_(value) << CAN_IER_MB6_Pos)) /* Assignment of value for MB6 in the CAN_IER register */
...
#define CAN_IER_MB7(value)                    (CAN_IER_MB7_Msk & (_UINT32_(value) << CAN_IER_MB7_Pos)) /* Assignment of value for MB7 in the CAN_IER register */
...
#define CAN_IER_ERRA(value)                   (CAN_IER_ERRA_Msk & (_UINT32_(value) << CAN_IER_ERRA_Pos)) /* Assignment of value for ERRA in the CAN_IER register */
...
#define CAN_IER_WARN(value)                   (CAN_IER_WARN_Msk & (_UINT32_(value) << CAN_IER_WARN_Pos)) /* Assignment of value for WARN in the CAN_IER register */
...
#define CAN_IER_ERRP(value)                   (CAN_IER_ERRP_Msk & (_UINT32_(value) << CAN_IER_ERRP_Pos)) /* Assignment of value for ERRP in the CAN_IER register */
...
#define CAN_IER_BOFF(value)                   (CAN_IER_BOFF_Msk & (_UINT32_(value) << CAN_IER_BOFF_Pos)) /* Assignment of value for BOFF in the CAN_IER register */
...
#define CAN_IER_SLEEP(value)                  (CAN_IER_SLEEP_Msk & (_UINT32_(value) << CAN_IER_SLEEP_Pos)) /* Assignment of value for SLEEP in the CAN_IER register */
...
#define CAN_IER_WAKEUP(value)                 (CAN_IER_WAKEUP_Msk & (_UINT32_(value) << CAN_IER_WAKEUP_Pos)) /* Assignment of value for WAKEUP in the CAN_IER register */
...
#define CAN_IER_TOVF(value)                   (CAN_IER_TOVF_Msk & (_UINT32_(value) << CAN_IER_TOVF_Pos)) /* Assignment of value for TOVF in the CAN_IER register */
...
#define CAN_IER_TSTP(value)                   (CAN_IER_TSTP_Msk & (_UINT32_(value) << CAN_IER_TSTP_Pos)) /* Assignment of value for TSTP in the CAN_IER register */
...
#define CAN_IER_CERR(value)                   (CAN_IER_CERR_Msk & (_UINT32_(value) << CAN_IER_CERR_Pos)) /* Assignment of value for CERR in the CAN_IER register */
...
#define CAN_IER_SERR(value)                   (CAN_IER_SERR_Msk & (_UINT32_(value) << CAN_IER_SERR_Pos)) /* Assignment of value for SERR in the CAN_IER register */
...
#define CAN_IER_AERR(value)                   (CAN_IER_AERR_Msk & (_UINT32_(value) << CAN_IER_AERR_Pos)) /* Assignment of value for AERR in the CAN_IER register */
...
#define CAN_IER_FERR(value)                   (CAN_IER_FERR_Msk & (_UINT32_(value) << CAN_IER_FERR_Pos)) /* Assignment of value for FERR in the CAN_IER register */
...
#define CAN_IER_BERR(value)                   (CAN_IER_BERR_Msk & (_UINT32_(value) << CAN_IER_BERR_Pos)) /* Assignment of value for BERR in the CAN_IER register */
...
#define CAN_IDR_MB0(value)                    (CAN_IDR_MB0_Msk & (_UINT32_(value) << CAN_IDR_MB0_Pos)) /* Assignment of value for MB0 in the CAN_IDR register */
...
#define CAN_IDR_MB1(value)                    (CAN_IDR_MB1_Msk & (_UINT32_(value) << CAN_IDR_MB1_Pos)) /* Assignment of value for MB1 in the CAN_IDR register */
...
#define CAN_IDR_MB2(value)                    (CAN_IDR_MB2_Msk & (_UINT32_(value) << CAN_IDR_MB2_Pos)) /* Assignment of value for MB2 in the CAN_IDR register */
...
#define CAN_IDR_MB3(value)                    (CAN_IDR_MB3_Msk & (_UINT32_(value) << CAN_IDR_MB3_Pos)) /* Assignment of value for MB3 in the CAN_IDR register */
...
#define CAN_IDR_MB4(value)                    (CAN_IDR_MB4_Msk & (_UINT32_(value) << CAN_IDR_MB4_Pos)) /* Assignment of value for MB4 in the CAN_IDR register */
...
#define CAN_IDR_MB5(value)                    (CAN_IDR_MB5_Msk & (_UINT32_(value) << CAN_IDR_MB5_Pos)) /* Assignment of value for MB5 in the CAN_IDR register */
...
#define CAN_IDR_MB6(value)                    (CAN_IDR_MB6_Msk & (_UINT32_(value) << CAN_IDR_MB6_Pos)) /* Assignment of value for MB6 in the CAN_IDR register */
...
#define CAN_IDR_MB7(value)                    (CAN_IDR_MB7_Msk & (_UINT32_(value) << CAN_IDR_MB7_Pos)) /* Assignment of value for MB7 in the CAN_IDR register */
...
#define CAN_IDR_ERRA(value)                   (CAN_IDR_ERRA_Msk & (_UINT32_(value) << CAN_IDR_ERRA_Pos)) /* Assignment of value for ERRA in the CAN_IDR register */
...
#define CAN_IDR_WARN(value)                   (CAN_IDR_WARN_Msk & (_UINT32_(value) << CAN_IDR_WARN_Pos)) /* Assignment of value for WARN in the CAN_IDR register */
...
#define CAN_IDR_ERRP(value)                   (CAN_IDR_ERRP_Msk & (_UINT32_(value) << CAN_IDR_ERRP_Pos)) /* Assignment of value for ERRP in the CAN_IDR register */
...
#define CAN_IDR_BOFF(value)                   (CAN_IDR_BOFF_Msk & (_UINT32_(value) << CAN_IDR_BOFF_Pos)) /* Assignment of value for BOFF in the CAN_IDR register */
...
#define CAN_IDR_SLEEP(value)                  (CAN_IDR_SLEEP_Msk & (_UINT32_(value) << CAN_IDR_SLEEP_Pos)) /* Assignment of value for SLEEP in the CAN_IDR register */
...
#define CAN_IDR_WAKEUP(value)                 (CAN_IDR_WAKEUP_Msk & (_UINT32_(value) << CAN_IDR_WAKEUP_Pos)) /* Assignment of value for WAKEUP in the CAN_IDR register */
...
#define CAN_IDR_TOVF(value)                   (CAN_IDR_TOVF_Msk & (_UINT32_(value) << CAN_IDR_TOVF_Pos)) /* Assignment of value for TOVF in the CAN_IDR register */
...
#define CAN_IDR_TSTP(value)                   (CAN_IDR_TSTP_Msk & (_UINT32_(value) << CAN_IDR_TSTP_Pos)) /* Assignment of value for TSTP in the CAN_IDR register */
...
#define CAN_IDR_CERR(value)                   (CAN_IDR_CERR_Msk & (_UINT32_(value) << CAN_IDR_CERR_Pos)) /* Assignment of value for CERR in the CAN_IDR register */
...
#define CAN_IDR_SERR(value)                   (CAN_IDR_SERR_Msk & (_UINT32_(value) << CAN_IDR_SERR_Pos)) /* Assignment of value for SERR in the CAN_IDR register */
...
#define CAN_IDR_AERR(value)                   (CAN_IDR_AERR_Msk & (_UINT32_(value) << CAN_IDR_AERR_Pos)) /* Assignment of value for AERR in the CAN_IDR register */
...
#define CAN_IDR_FERR(value)                   (CAN_IDR_FERR_Msk & (_UINT32_(value) << CAN_IDR_FERR_Pos)) /* Assignment of value for FERR in the CAN_IDR register */
...
#define CAN_IDR_BERR(value)                   (CAN_IDR_BERR_Msk & (_UINT32_(value) << CAN_IDR_BERR_Pos)) /* Assignment of value for BERR in the CAN_IDR register */
...
#define CAN_IMR_MB0(value)                    (CAN_IMR_MB0_Msk & (_UINT32_(value) << CAN_IMR_MB0_Pos)) /* Assignment of value for MB0 in the CAN_IMR register */
...
#define CAN_IMR_MB1(value)                    (CAN_IMR_MB1_Msk & (_UINT32_(value) << CAN_IMR_MB1_Pos)) /* Assignment of value for MB1 in the CAN_IMR register */
...
#define CAN_IMR_MB2(value)                    (CAN_IMR_MB2_Msk & (_UINT32_(value) << CAN_IMR_MB2_Pos)) /* Assignment of value for MB2 in the CAN_IMR register */
...
#define CAN_IMR_MB3(value)                    (CAN_IMR_MB3_Msk & (_UINT32_(value) << CAN_IMR_MB3_Pos)) /* Assignment of value for MB3 in the CAN_IMR register */
...
#define CAN_IMR_MB4(value)                    (CAN_IMR_MB4_Msk & (_UINT32_(value) << CAN_IMR_MB4_Pos)) /* Assignment of value for MB4 in the CAN_IMR register */
...
#define CAN_IMR_MB5(value)                    (CAN_IMR_MB5_Msk & (_UINT32_(value) << CAN_IMR_MB5_Pos)) /* Assignment of value for MB5 in the CAN_IMR register */
...
#define CAN_IMR_MB6(value)                    (CAN_IMR_MB6_Msk & (_UINT32_(value) << CAN_IMR_MB6_Pos)) /* Assignment of value for MB6 in the CAN_IMR register */
...
#define CAN_IMR_MB7(value)                    (CAN_IMR_MB7_Msk & (_UINT32_(value) << CAN_IMR_MB7_Pos)) /* Assignment of value for MB7 in the CAN_IMR register */
...
#define CAN_IMR_ERRA(value)                   (CAN_IMR_ERRA_Msk & (_UINT32_(value) << CAN_IMR_ERRA_Pos)) /* Assignment of value for ERRA in the CAN_IMR register */
...
#define CAN_IMR_WARN(value)                   (CAN_IMR_WARN_Msk & (_UINT32_(value) << CAN_IMR_WARN_Pos)) /* Assignment of value for WARN in the CAN_IMR register */
...
#define CAN_IMR_ERRP(value)                   (CAN_IMR_ERRP_Msk & (_UINT32_(value) << CAN_IMR_ERRP_Pos)) /* Assignment of value for ERRP in the CAN_IMR register */
...
#define CAN_IMR_BOFF(value)                   (CAN_IMR_BOFF_Msk & (_UINT32_(value) << CAN_IMR_BOFF_Pos)) /* Assignment of value for BOFF in the CAN_IMR register */
...
#define CAN_IMR_SLEEP(value)                  (CAN_IMR_SLEEP_Msk & (_UINT32_(value) << CAN_IMR_SLEEP_Pos)) /* Assignment of value for SLEEP in the CAN_IMR register */
...
#define CAN_IMR_WAKEUP(value)                 (CAN_IMR_WAKEUP_Msk & (_UINT32_(value) << CAN_IMR_WAKEUP_Pos)) /* Assignment of value for WAKEUP in the CAN_IMR register */
...
#define CAN_IMR_TOVF(value)                   (CAN_IMR_TOVF_Msk & (_UINT32_(value) << CAN_IMR_TOVF_Pos)) /* Assignment of value for TOVF in the CAN_IMR register */
...
#define CAN_IMR_TSTP(value)                   (CAN_IMR_TSTP_Msk & (_UINT32_(value) << CAN_IMR_TSTP_Pos)) /* Assignment of value for TSTP in the CAN_IMR register */
...
#define CAN_IMR_CERR(value)                   (CAN_IMR_CERR_Msk & (_UINT32_(value) << CAN_IMR_CERR_Pos)) /* Assignment of value for CERR in the CAN_IMR register */
...
#define CAN_IMR_SERR(value)                   (CAN_IMR_SERR_Msk & (_UINT32_(value) << CAN_IMR_SERR_Pos)) /* Assignment of value for SERR in the CAN_IMR register */
...
#define CAN_IMR_AERR(value)                   (CAN_IMR_AERR_Msk & (_UINT32_(value) << CAN_IMR_AERR_Pos)) /* Assignment of value for AERR in the CAN_IMR register */
...
#define CAN_IMR_FERR(value)                   (CAN_IMR_FERR_Msk & (_UINT32_(value) << CAN_IMR_FERR_Pos)) /* Assignment of value for FERR in the CAN_IMR register */
...
#define CAN_IMR_BERR(value)                   (CAN_IMR_BERR_Msk & (_UINT32_(value) << CAN_IMR_BERR_Pos)) /* Assignment of value for BERR in the CAN_IMR register */
...
#define CAN_SR_MB0(value)                     (CAN_SR_MB0_Msk & (_UINT32_(value) << CAN_SR_MB0_Pos)) /* Assignment of value for MB0 in the CAN_SR register */
...
#define CAN_SR_MB1(value)                     (CAN_SR_MB1_Msk & (_UINT32_(value) << CAN_SR_MB1_Pos)) /* Assignment of value for MB1 in the CAN_SR register */
...
#define CAN_SR_MB2(value)                     (CAN_SR_MB2_Msk & (_UINT32_(value) << CAN_SR_MB2_Pos)) /* Assignment of value for MB2 in the CAN_SR register */
...
#define CAN_SR_MB3(value)                     (CAN_SR_MB3_Msk & (_UINT32_(value) << CAN_SR_MB3_Pos)) /* Assignment of value for MB3 in the CAN_SR register */
...
#define CAN_SR_MB4(value)                     (CAN_SR_MB4_Msk & (_UINT32_(value) << CAN_SR_MB4_Pos)) /* Assignment of value for MB4 in the CAN_SR register */
...
#define CAN_SR_MB5(value)                     (CAN_SR_MB5_Msk & (_UINT32_(value) << CAN_SR_MB5_Pos)) /* Assignment of value for MB5 in the CAN_SR register */
...
#define CAN_SR_MB6(value)                     (CAN_SR_MB6_Msk & (_UINT32_(value) << CAN_SR_MB6_Pos)) /* Assignment of value for MB6 in the CAN_SR register */
...
#define CAN_SR_MB7(value)                     (CAN_SR_MB7_Msk & (_UINT32_(value) << CAN_SR_MB7_Pos)) /* Assignment of value for MB7 in the CAN_SR register */
...
#define CAN_SR_ERRA(value)                    (CAN_SR_ERRA_Msk & (_UINT32_(value) << CAN_SR_ERRA_Pos)) /* Assignment of value for ERRA in the CAN_SR register */
...
#define CAN_SR_WARN(value)                    (CAN_SR_WARN_Msk & (_UINT32_(value) << CAN_SR_WARN_Pos)) /* Assignment of value for WARN in the CAN_SR register */
...
#define CAN_SR_ERRP(value)                    (CAN_SR_ERRP_Msk & (_UINT32_(value) << CAN_SR_ERRP_Pos)) /* Assignment of value for ERRP in the CAN_SR register */
...
#define CAN_SR_BOFF(value)                    (CAN_SR_BOFF_Msk & (_UINT32_(value) << CAN_SR_BOFF_Pos)) /* Assignment of value for BOFF in the CAN_SR register */
...
#define CAN_SR_SLEEP(value)                   (CAN_SR_SLEEP_Msk & (_UINT32_(value) << CAN_SR_SLEEP_Pos)) /* Assignment of value for SLEEP in the CAN_SR register */
...
#define CAN_SR_WAKEUP(value)                  (CAN_SR_WAKEUP_Msk & (_UINT32_(value) << CAN_SR_WAKEUP_Pos)) /* Assignment of value for WAKEUP in the CAN_SR register */
...
#define CAN_SR_TOVF(value)                    (CAN_SR_TOVF_Msk & (_UINT32_(value) << CAN_SR_TOVF_Pos)) /* Assignment of value for TOVF in the CAN_SR register */
...
#define CAN_SR_TSTP(value)                    (CAN_SR_TSTP_Msk & (_UINT32_(value) << CAN_SR_TSTP_Pos)) /* Assignment of value for TSTP in the CAN_SR register */
...
#define CAN_SR_CERR(value)                    (CAN_SR_CERR_Msk & (_UINT32_(value) << CAN_SR_CERR_Pos)) /* Assignment of value for CERR in the CAN_SR register */
...
#define CAN_SR_SERR(value)                    (CAN_SR_SERR_Msk & (_UINT32_(value) << CAN_SR_SERR_Pos)) /* Assignment of value for SERR in the CAN_SR register */
...
#define CAN_SR_AERR(value)                    (CAN_SR_AERR_Msk & (_UINT32_(value) << CAN_SR_AERR_Pos)) /* Assignment of value for AERR in the CAN_SR register */
...
#define CAN_SR_FERR(value)                    (CAN_SR_FERR_Msk & (_UINT32_(value) << CAN_SR_FERR_Pos)) /* Assignment of value for FERR in the CAN_SR register */
...
#define CAN_SR_BERR(value)                    (CAN_SR_BERR_Msk & (_UINT32_(value) << CAN_SR_BERR_Pos)) /* Assignment of value for BERR in the CAN_SR register */
...
#define CAN_SR_RBSY(value)                    (CAN_SR_RBSY_Msk & (_UINT32_(value) << CAN_SR_RBSY_Pos)) /* Assignment of value for RBSY in the CAN_SR register */
...
#define CAN_SR_TBSY(value)                    (CAN_SR_TBSY_Msk & (_UINT32_(value) << CAN_SR_TBSY_Pos)) /* Assignment of value for TBSY in the CAN_SR register */
...
#define CAN_SR_OVLSY(value)                   (CAN_SR_OVLSY_Msk & (_UINT32_(value) << CAN_SR_OVLSY_Pos)) /* Assignment of value for OVLSY in the CAN_SR register */
...
#define CAN_BR_PHASE2(value)                  (CAN_BR_PHASE2_Msk & (_UINT32_(value) << CAN_BR_PHASE2_Pos)) /* Assignment of value for PHASE2 in the CAN_BR register */
...
#define CAN_BR_PHASE1(value)                  (CAN_BR_PHASE1_Msk & (_UINT32_(value) << CAN_BR_PHASE1_Pos)) /* Assignment of value for PHASE1 in the CAN_BR register */
...
#define CAN_BR_PROPAG(value)                  (CAN_BR_PROPAG_Msk & (_UINT32_(value) << CAN_BR_PROPAG_Pos)) /* Assignment of value for PROPAG in the CAN_BR register */
...
#define CAN_BR_SJW(value)                     (CAN_BR_SJW_Msk & (_UINT32_(value) << CAN_BR_SJW_Pos)) /* Assignment of value for SJW in the CAN_BR register */
...
#define CAN_BR_BRP(value)                     (CAN_BR_BRP_Msk & (_UINT32_(value) << CAN_BR_BRP_Pos)) /* Assignment of value for BRP in the CAN_BR register */
...
#define CAN_BR_SMP(value)                     (CAN_BR_SMP_Msk & (_UINT32_(value) << CAN_BR_SMP_Pos)) /* Assignment of value for SMP in the CAN_BR register */
...
#define CAN_TIM_TIMER(value)                  (CAN_TIM_TIMER_Msk & (_UINT32_(value) << CAN_TIM_TIMER_Pos)) /* Assignment of value for TIMER in the CAN_TIM register */
...
#define CAN_TIMESTP_MTIMESTAMP(value)         (CAN_TIMESTP_MTIMESTAMP_Msk & (_UINT32_(value) << CAN_TIMESTP_MTIMESTAMP_Pos)) /* Assignment of value for MTIMESTAMP in the CAN_TIMESTP register */
...
#define CAN_TCR_MB0(value)                    (CAN_TCR_MB0_Msk & (_UINT32_(value) << CAN_TCR_MB0_Pos)) /* Assignment of value for MB0 in the CAN_TCR register */
...
#define CAN_TCR_MB1(value)                    (CAN_TCR_MB1_Msk & (_UINT32_(value) << CAN_TCR_MB1_Pos)) /* Assignment of value for MB1 in the CAN_TCR register */
...
#define CAN_TCR_MB2(value)                    (CAN_TCR_MB2_Msk & (_UINT32_(value) << CAN_TCR_MB2_Pos)) /* Assignment of value for MB2 in the CAN_TCR register */
...
#define CAN_TCR_MB3(value)                    (CAN_TCR_MB3_Msk & (_UINT32_(value) << CAN_TCR_MB3_Pos)) /* Assignment of value for MB3 in the CAN_TCR register */
...
#define CAN_TCR_MB4(value)                    (CAN_TCR_MB4_Msk & (_UINT32_(value) << CAN_TCR_MB4_Pos)) /* Assignment of value for MB4 in the CAN_TCR register */
...
#define CAN_TCR_MB5(value)                    (CAN_TCR_MB5_Msk & (_UINT32_(value) << CAN_TCR_MB5_Pos)) /* Assignment of value for MB5 in the CAN_TCR register */
...
#define CAN_TCR_MB6(value)                    (CAN_TCR_MB6_Msk & (_UINT32_(value) << CAN_TCR_MB6_Pos)) /* Assignment of value for MB6 in the CAN_TCR register */
...
#define CAN_TCR_MB7(value)                    (CAN_TCR_MB7_Msk & (_UINT32_(value) << CAN_TCR_MB7_Pos)) /* Assignment of value for MB7 in the CAN_TCR register */
...
#define CAN_TCR_TIMRST(value)                 (CAN_TCR_TIMRST_Msk & (_UINT32_(value) << CAN_TCR_TIMRST_Pos)) /* Assignment of value for TIMRST in the CAN_TCR register */
...
#define CAN_ACR_MB0(value)                    (CAN_ACR_MB0_Msk & (_UINT32_(value) << CAN_ACR_MB0_Pos)) /* Assignment of value for MB0 in the CAN_ACR register */
...
#define CAN_ACR_MB1(value)                    (CAN_ACR_MB1_Msk & (_UINT32_(value) << CAN_ACR_MB1_Pos)) /* Assignment of value for MB1 in the CAN_ACR register */
...
#define CAN_ACR_MB2(value)                    (CAN_ACR_MB2_Msk & (_UINT32_(value) << CAN_ACR_MB2_Pos)) /* Assignment of value for MB2 in the CAN_ACR register */
...
#define CAN_ACR_MB3(value)                    (CAN_ACR_MB3_Msk & (_UINT32_(value) << CAN_ACR_MB3_Pos)) /* Assignment of value for MB3 in the CAN_ACR register */
...
#define CAN_ACR_MB4(value)                    (CAN_ACR_MB4_Msk & (_UINT32_(value) << CAN_ACR_MB4_Pos)) /* Assignment of value for MB4 in the CAN_ACR register */
...
#define CAN_ACR_MB5(value)                    (CAN_ACR_MB5_Msk & (_UINT32_(value) << CAN_ACR_MB5_Pos)) /* Assignment of value for MB5 in the CAN_ACR register */
...
#define CAN_ACR_MB6(value)                    (CAN_ACR_MB6_Msk & (_UINT32_(value) << CAN_ACR_MB6_Pos)) /* Assignment of value for MB6 in the CAN_ACR register */
...
#define CAN_ACR_MB7(value)                    (CAN_ACR_MB7_Msk & (_UINT32_(value) << CAN_ACR_MB7_Pos)) /* Assignment of value for MB7 in the CAN_ACR register */
...
#define CAN_WPMR_WPEN(value)                  (CAN_WPMR_WPEN_Msk & (_UINT32_(value) << CAN_WPMR_WPEN_Pos)) /* Assignment of value for WPEN in the CAN_WPMR register */
...
#define CAN_WPMR_WPKEY(value)                 (CAN_WPMR_WPKEY_Msk & (_UINT32_(value) << CAN_WPMR_WPKEY_Pos)) /* Assignment of value for WPKEY in the CAN_WPMR register */
...
#define CAN_WPSR_WPVS(value)                  (CAN_WPSR_WPVS_Msk & (_UINT32_(value) << CAN_WPSR_WPVS_Pos)) /* Assignment of value for WPVS in the CAN_WPSR register */
...
#define CAN_WPSR_WPVSRC(value)                (CAN_WPSR_WPVSRC_Msk & (_UINT32_(value) << CAN_WPSR_WPVSRC_Pos)) /* Assignment of value for WPVSRC in the CAN_WPSR register */
