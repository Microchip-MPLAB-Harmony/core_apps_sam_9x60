...
#define ADC_PDR_PDIFF8(value)                 (ADC_PDR_PDIFF8_Msk & (_UINT32_(value) << ADC_PDR_PDIFF8_Pos)) /* Assignment of value for PDIFF8 in the ADC_PDR register */
...
#define ADC_PDR_PDIFF9(value)                 (ADC_PDR_PDIFF9_Msk & (_UINT32_(value) << ADC_PDR_PDIFF9_Pos)) /* Assignment of value for PDIFF9 in the ADC_PDR register */
...
#define ADC_PDR_PDIFF10(value)                (ADC_PDR_PDIFF10_Msk & (_UINT32_(value) << ADC_PDR_PDIFF10_Pos)) /* Assignment of value for PDIFF10 in the ADC_PDR register */
...
#define ADC_PDR_PDIFF11(value)                (ADC_PDR_PDIFF11_Msk & (_UINT32_(value) << ADC_PDR_PDIFF11_Pos)) /* Assignment of value for PDIFF11 in the ADC_PDR register */
#define ADC_PDR_Msk                           _UINT32_(0x00000FFF)                                 /* (ADC_PDR) Register Mask  */

#define ADC_PDR_PDIFF_Pos                     _UINT32_(0)                                          /* (ADC_PDR Position) Pseudo-Differential Inputs for Channel xx */
#define ADC_PDR_PDIFF_Msk                     (_UINT32_(0xFFF) << ADC_PDR_PDIFF_Pos)               /* (ADC_PDR Mask) PDIFF */
