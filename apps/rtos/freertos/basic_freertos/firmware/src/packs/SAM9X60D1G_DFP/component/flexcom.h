...
/* LON mode */
#define FLEX_US_IER_LON_RXRDY_Pos             _UINT32_(0)                                          /* (FLEX_US_IER) RXRDY Interrupt Enable Position */
#define FLEX_US_IER_LON_RXRDY_Msk             (_UINT32_(0x1) << FLEX_US_IER_LON_RXRDY_Pos)         /* (FLEX_US_IER) RXRDY Interrupt Enable Mask */
#define FLEX_US_IER_LON_RXRDY(value)          (FLEX_US_IER_LON_RXRDY_Msk & (_UINT32_(value) << FLEX_US_IER_LON_RXRDY_Pos))
#define FLEX_US_IER_LON_TXRDY_Pos             _UINT32_(1)                                          /* (FLEX_US_IER) TXRDY Interrupt Enable Position */
#define FLEX_US_IER_LON_TXRDY_Msk             (_UINT32_(0x1) << FLEX_US_IER_LON_TXRDY_Pos)         /* (FLEX_US_IER) TXRDY Interrupt Enable Mask */
#define FLEX_US_IER_LON_TXRDY(value)          (FLEX_US_IER_LON_TXRDY_Msk & (_UINT32_(value) << FLEX_US_IER_LON_TXRDY_Pos))
#define FLEX_US_IER_LON_OVRE_Pos              _UINT32_(5)                                          /* (FLEX_US_IER) Overrun Error Interrupt Enable Position */
#define FLEX_US_IER_LON_OVRE_Msk              (_UINT32_(0x1) << FLEX_US_IER_LON_OVRE_Pos)          /* (FLEX_US_IER) Overrun Error Interrupt Enable Mask */
#define FLEX_US_IER_LON_OVRE(value)           (FLEX_US_IER_LON_OVRE_Msk & (_UINT32_(value) << FLEX_US_IER_LON_OVRE_Pos))
...
#define FLEX_US_IER_LON_TXEMPTY_Pos           _UINT32_(9)                                          /* (FLEX_US_IER) TXEMPTY Interrupt Enable Position */
#define FLEX_US_IER_LON_TXEMPTY_Msk           (_UINT32_(0x1) << FLEX_US_IER_LON_TXEMPTY_Pos)       /* (FLEX_US_IER) TXEMPTY Interrupt Enable Mask */
#define FLEX_US_IER_LON_TXEMPTY(value)        (FLEX_US_IER_LON_TXEMPTY_Msk & (_UINT32_(value) << FLEX_US_IER_LON_TXEMPTY_Pos))
...
#define FLEX_US_IER_LON_Msk                   _UINT32_(0x1F0006E3)                                 /* (FLEX_US_IER_LON) Register Mask  */
...
/* LON mode */
#define FLEX_US_IDR_LON_RXRDY_Pos             _UINT32_(0)                                          /* (FLEX_US_IDR) RXRDY Interrupt Disable Position */
#define FLEX_US_IDR_LON_RXRDY_Msk             (_UINT32_(0x1) << FLEX_US_IDR_LON_RXRDY_Pos)         /* (FLEX_US_IDR) RXRDY Interrupt Disable Mask */
#define FLEX_US_IDR_LON_RXRDY(value)          (FLEX_US_IDR_LON_RXRDY_Msk & (_UINT32_(value) << FLEX_US_IDR_LON_RXRDY_Pos))
#define FLEX_US_IDR_LON_TXRDY_Pos             _UINT32_(1)                                          /* (FLEX_US_IDR) TXRDY Interrupt Disable Position */
#define FLEX_US_IDR_LON_TXRDY_Msk             (_UINT32_(0x1) << FLEX_US_IDR_LON_TXRDY_Pos)         /* (FLEX_US_IDR) TXRDY Interrupt Disable Mask */
#define FLEX_US_IDR_LON_TXRDY(value)          (FLEX_US_IDR_LON_TXRDY_Msk & (_UINT32_(value) << FLEX_US_IDR_LON_TXRDY_Pos))
#define FLEX_US_IDR_LON_OVRE_Pos              _UINT32_(5)                                          /* (FLEX_US_IDR) Overrun Error Interrupt Disable Position */
#define FLEX_US_IDR_LON_OVRE_Msk              (_UINT32_(0x1) << FLEX_US_IDR_LON_OVRE_Pos)          /* (FLEX_US_IDR) Overrun Error Interrupt Disable Mask */
#define FLEX_US_IDR_LON_OVRE(value)           (FLEX_US_IDR_LON_OVRE_Msk & (_UINT32_(value) << FLEX_US_IDR_LON_OVRE_Pos))
...
#define FLEX_US_IDR_LON_TXEMPTY_Pos           _UINT32_(9)                                          /* (FLEX_US_IDR) TXEMPTY Interrupt Disable Position */
#define FLEX_US_IDR_LON_TXEMPTY_Msk           (_UINT32_(0x1) << FLEX_US_IDR_LON_TXEMPTY_Pos)       /* (FLEX_US_IDR) TXEMPTY Interrupt Disable Mask */
#define FLEX_US_IDR_LON_TXEMPTY(value)        (FLEX_US_IDR_LON_TXEMPTY_Msk & (_UINT32_(value) << FLEX_US_IDR_LON_TXEMPTY_Pos))
...
#define FLEX_US_IDR_LON_Msk                   _UINT32_(0x1F0006E3)                                 /* (FLEX_US_IDR_LON) Register Mask  */
...
/* LON mode */
#define FLEX_US_IMR_LON_RXRDY_Pos             _UINT32_(0)                                          /* (FLEX_US_IMR) RXRDY Interrupt Mask Position */
#define FLEX_US_IMR_LON_RXRDY_Msk             (_UINT32_(0x1) << FLEX_US_IMR_LON_RXRDY_Pos)         /* (FLEX_US_IMR) RXRDY Interrupt Mask Mask */
#define FLEX_US_IMR_LON_RXRDY(value)          (FLEX_US_IMR_LON_RXRDY_Msk & (_UINT32_(value) << FLEX_US_IMR_LON_RXRDY_Pos))
#define FLEX_US_IMR_LON_TXRDY_Pos             _UINT32_(1)                                          /* (FLEX_US_IMR) TXRDY Interrupt Mask Position */
#define FLEX_US_IMR_LON_TXRDY_Msk             (_UINT32_(0x1) << FLEX_US_IMR_LON_TXRDY_Pos)         /* (FLEX_US_IMR) TXRDY Interrupt Mask Mask */
#define FLEX_US_IMR_LON_TXRDY(value)          (FLEX_US_IMR_LON_TXRDY_Msk & (_UINT32_(value) << FLEX_US_IMR_LON_TXRDY_Pos))
#define FLEX_US_IMR_LON_OVRE_Pos              _UINT32_(5)                                          /* (FLEX_US_IMR) Overrun Error Interrupt Mask Position */
#define FLEX_US_IMR_LON_OVRE_Msk              (_UINT32_(0x1) << FLEX_US_IMR_LON_OVRE_Pos)          /* (FLEX_US_IMR) Overrun Error Interrupt Mask Mask */
#define FLEX_US_IMR_LON_OVRE(value)           (FLEX_US_IMR_LON_OVRE_Msk & (_UINT32_(value) << FLEX_US_IMR_LON_OVRE_Pos))
...
#define FLEX_US_IMR_LON_TXEMPTY_Pos           _UINT32_(9)                                          /* (FLEX_US_IMR) TXEMPTY Interrupt Mask Position */
#define FLEX_US_IMR_LON_TXEMPTY_Msk           (_UINT32_(0x1) << FLEX_US_IMR_LON_TXEMPTY_Pos)       /* (FLEX_US_IMR) TXEMPTY Interrupt Mask Mask */
#define FLEX_US_IMR_LON_TXEMPTY(value)        (FLEX_US_IMR_LON_TXEMPTY_Msk & (_UINT32_(value) << FLEX_US_IMR_LON_TXEMPTY_Pos))
...
#define FLEX_US_IMR_LON_Msk                   _UINT32_(0x1F0006E3)                                 /* (FLEX_US_IMR_LON) Register Mask  */
...
#define FLEX_US_CSR_LON_OVRE_Pos              _UINT32_(5)                                          /* (FLEX_US_CSR) Overrun Error Position */
#define FLEX_US_CSR_LON_OVRE_Msk              (_UINT32_(0x1) << FLEX_US_CSR_LON_OVRE_Pos)          /* (FLEX_US_CSR) Overrun Error Mask */
#define FLEX_US_CSR_LON_OVRE(value)           (FLEX_US_CSR_LON_OVRE_Msk & (_UINT32_(value) << FLEX_US_CSR_LON_OVRE_Pos))
...
#define FLEX_US_CSR_LON_TXEMPTY_Pos           _UINT32_(9)                                          /* (FLEX_US_CSR) Transmitter Empty (cleared by writing FLEX_US_THR) Position */
#define FLEX_US_CSR_LON_TXEMPTY_Msk           (_UINT32_(0x1) << FLEX_US_CSR_LON_TXEMPTY_Pos)       /* (FLEX_US_CSR) Transmitter Empty (cleared by writing FLEX_US_THR) Mask */
#define FLEX_US_CSR_LON_TXEMPTY(value)        (FLEX_US_CSR_LON_TXEMPTY_Msk & (_UINT32_(value) << FLEX_US_CSR_LON_TXEMPTY_Pos))
...
#define FLEX_US_CSR_LON_Msk                   _UINT32_(0x1F0006E3)                                 /* (FLEX_US_CSR_LON) Register Mask  */
