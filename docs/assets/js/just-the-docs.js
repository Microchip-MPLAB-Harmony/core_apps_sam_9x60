...
{"0": {
    ...
    "content": "To load the application binary onto the target device, we need to use at91bootstrap loader. Refer to the at91bootstrap loader documentation for details on how to use it to bootstrap the application binaries. ",
    ...
    "content": "The following table shows the target hardware for the application projects. | Project Name | Board | . | sam_9x60_curiosity.X sam_9x60_curiosity_freertos.X | SAM9X60-Curiosity board | . |   |   | . Setting up SAM9X60-Curiosity board . Addtional hardware required . | Insert USB UART CLICK board into MIKROBUS Connector J8 | Connect the USB port J1 on board to the computer using a micro USB cable (to power the board) | Connect the JTAG J12 on board to the computer using a JTAG based debugger | Connect the J11 on board to the computer using a UART-FTDI cable (to enable debug com port) | . ",
    ...
    "content": ". | Open the Terminal application (Ex.:Tera term) on the computer for both ports | Connect the COM port and configure the serial settings as follows (for both ports): . | Baud : 115200 | Data : 8 Bits | Parity : None | Stop : 1 Bit | Flow Control : None | . | Build and program the application using its IDE | Type a character and observe the output on the two consoles as shown below: . | If success the character typed echoes back and an LED toggles on each time the character is echoed | Console 1 | . | Console 2 | . | . Refer to the following table for LED name: . | Board | LED Name | . | SAM9X60-Curiosity board | RGB_LED(Green) | . |   |   | . ",
    ...
    "doc": "I2C driver asynchronous - I2C EEPROM",
    "title": "Description",
    "content": "This example uses the I2C driver in asynchronous mode to communicate with the EEPROM to perform write and read operations in Bare-Metal environment. This application uses I2C driver to read and write data from an from an on-Board 24AA025E48 EEPROM device. ",
    ...
    "doc": "I2C driver asynchronous - I2C EEPROM",
    "title": "Setting up the hardware",
    "content": "The following table shows the target hardware for the application projects. | Project Name | Board | . | sam_9x60_curiosity.X sam_9x60_curiosity_freertos.X | SAM9X60-Curiosity board | . |   |   | . Setting up SAM9X60-Curiosity board . | Connect the USB port J1 on board to the computer using a micro USB cable (to power the board) | Connect the JTAG J12 on board to the computer using a JTAG based debugger | . ",
    ...
    "doc": "I2C driver asynchronous - I2C EEPROM",
    "title": "Running the Application",
    "content": ". | Build and program the application using its IDE | The LED is turned ON when the value read from the EEPROM matched with the written value | . Refer to the following table for LED name: . | Board | LED Name | . | SAM9X60-Curiosity board | RGB_LED(Green) | . |   |   | . ",
    ...
    "doc": "I2C driver synchronous - I2C EEPROM",
    "title": "Description",
    "content": "This example uses the I2C driver in synchronous mode to communicate with the EEPROM to perform write and read operations in Bare-Metal environment. This application uses I2C driver to read and write data from an on-Board 24AA025E48 EEPROM device. ",
    ...
    "doc": "I2C driver synchronous - I2C EEPROM",
    "title": "Setting up the hardware",
    "content": "The following table shows the target hardware for the application projects. | Project Name | Board | . | sam_9x60_curiosity_freertos.X | SAM9X60-Curiosity board | . |   |   | . Setting up SAM9X60-Curiosity board . | Connect the USB port J1 on board to the computer using a micro USB cable (to power the board) | Connect the JTAG J12 on board to the computer using a JTAG based debugger | . ",
    ...
    "doc": "I2C EEPROM AT24 driver - EEPROM Read Write",
    "title": "Setting up the hardware",
    "content": "The following table shows the target hardware for the application projects. | Project Name | Board | . | sam_9x60_curiosity.X sam_9x60_curiosity_freertos.X | SAM9X60-Curiosity board | . |   |   | . Setting up SAM9X60-Curiosity board . | Insert EEPROM 3 Click board into MIKROBUS Connector J8 | Connect the USB port J1 on board to the computer using a micro USB cable (to power the board) | Connect the JTAG J12 on board to the computer using a JTAG based debugger | . ",
    ...
    "doc": "I2C EEPROM AT24 driver - EEPROM Read Write",
    "title": "Running the Application",
    "content": ". | Build and program the application using its IDE | LED is turned ON when the data read from EEPROM matches with the written data | . Refer to the following table for LED name: . | Board | LED Name | . | SAM9X60-Curiosity board | RGB_LED(Green) | . |   |   | . ",
    ...
    "doc": "SDMMC driver asynchronous - SDMMC Read Write",
    "title": "Setting up the hardware",
    "content": "The following table shows the target hardware for the application projects. | Project Name | Board | . | sam_9x60_curiosity.X sam_9x60_curiosity_freertos.X | SAM9X60-Curiosity board | . |   |   | . Setting up SAM9X60-Curiosity board . | Insert the SD card into SDMMC0 (J3) slot on the board | Connect the USB port J1 on board to the computer using a micro USB cable (to power the board) | Connect the JTAG J12 on board to the computer using a JTAG based debugger | . ",
    ...
    "doc": "SMC NAND Flash driver - NAND Flash Read Write",
    "title": "Setting up the hardware",
    "content": "The following table shows the target hardware for the application projects. | Project Name | Board | . | sam_9x60_curiosity.X | SAM9X60-Curiosity board | . |   |   | . Setting up SAM9X60-Curiosity board . | Connect the USB port J1 on board to the computer using a micro USB cable (to power the board) | Connect the JTAG J12 on board to the computer using a JTAG based debugger | . ",
    ...
    "doc": "SMC NAND Flash driver - NAND Flash Read Write",
    "title": "Running the Application",
    "content": ". | Build and program the application using its IDE | The LED is turned ON when the value read from NAND Flash matches with the written data | . Refer to the following table for LED name: . | Board | LED Name | . | SAM9X60-Curiosity board | RGB_LED(Green) | . |   |   | . ",
    ...
    "doc": "SPI Driver asynchronous - Self loopback multi client",
    "title": "Setting up the hardware",
    "content": "The following table shows the target hardware for the application projects. | Project Name | Board | . | sam_9x60_curiosity.X sam_9x60_curiosity_freertos.X | SAM9X60-Curiosity board | . |   |   | . Setting up SAM9X60-Curiosity board . | Use jumper wire to Connect “MOSI Pin of mikroBUS Connector” to “MISO Pin of mikroBUS Connector” . | FLEXCOM5 MOSI signal is mapped to PA22 that is routed to “MOSI Pin of mikroBUS Connector” | FLEXCOM5 MISO signal is mapped to PA21 that is routed to “MISO Pin of mikroBUS Connector” | . | Connect the USB port J1 on board to the computer using a micro USB cable (to power the board) | Connect the JTAG J12 on board to the computer using a JTAG based debugger | . ",
    ...
    "doc": "SPI Driver asynchronous - Self loopback multi client",
    "title": "Running the Application",
    "content": ". | Build and program the application using its IDE | LED is turned ON on Success | . Refer to the following table for LED name: . | Board | LED Name | . | SAM9X60-Curiosity board | RGB_LED(Green) | . |   |   | . ",
    ...
    "doc": "SPI EEPROM AT25 driver - EEPROM Read Write",
    "title": "Setting up the hardware",
    "content": "The following table shows the target hardware for the application projects. | Project Name | Board | . | sam_9x60_curiosity.X sam_9x60_curiosity_freertos.X | SAM9X60-Curiosity board | . |   |   | . Setting up SAM9X60-Curiosity board . | Insert EEPROM 4 Click board into MIKROBUS Connector J8. | Connect the USB port J1 on board to the computer using a micro USB cable (to power the board) | Connect the JTAG J12 on board to the computer using a JTAG based debugger | . ",
    ...
    "doc": "SPI EEPROM AT25 driver - EEPROM Read Write",
    "title": "Running the Application",
    "content": ". | Build and program the application using its IDE | The LED is turned ON when the value read from EEPROM matches with the written data | . Refer to the following table for LED name: . | Board | LED Name | . | SAM9X60-Curiosity board | RGB_LED(Green) | . |   |   | . ",
    ...
    "doc": "Console Debug System Service using UART",
    "title": "Setting up the hardware",
    "content": "The following table shows the target hardware for the application projects. | Project Name | Board | . | sam_9x60_curiosity.X | SAM9X60-Curiosity board | . |   |   | . Setting up SAM9X60-Curiosity board . Addtional hardware required . | Connect the USB port J1 on board to the computer using a micro USB cable (to power the board) | Connect the JTAG J12 on board to the computer using a JTAG based debugger | Connect the J11 on board to the computer using a UART-FTDI cable (to enable debug com port) | . ",
    ...
    "doc": "USART driver synchronous - USART multi instance",
    "title": "Running the Application",
    "content": ". | Open the Terminal application (Ex.:Tera term) on the computer for both ports | Connect the COM port and configure the serial settings as follows (for both ports): . | Baud : 115200 | Data : 8 Bits | Parity : None | Stop : 1 Bit | Flow Control : None | . | Build and program the application using its IDE | Type ten characters and observe the output on the two consoles as shown below: . | If success, when ten characters are typed it will be echoed back on the console and LED is toggled every time the characters are echoed | Console 1 | . | Console 2 | . | . Refer to the following table for LED name: . | Board | LED Name | . | SAM9X60-Curiosity board | RGB_LED(Green) | . |   |   | . ",
    ...
    "doc": "FAT filesystem using RAM Media",
    "title": "Running the Application",
    "content": ". | Build and program the application using its IDE | The LED is turned ON if data has successfully been written and read back from file “newfile.txt” | . Refer to the following table for LED name: . | Board | LED Name | . | SAM9X60-Curiosity board | RGB_LED(Green) | . |   |   | . ",
    ...
    "doc": "FAT filesystem using SDMMC Media",
    "title": "Setting up the hardware",
    "content": "The following table shows the target hardware for the application projects. | Project Name | Board | . | sam_9x60_curiosity.X sam_9x60_curiosity_freertos.X | SAM9X60-Curiosity board | . |   |   | . Setting up SAM9X60-Curiosity board . | Insert the SD card into SDMMC0 (J3) slot on the board (SD Card with FAT32 file system and FILE_TOO_LONG_NAME_EXAMPLE_123.JPG file) | Connect the USB port J1 on board to the computer using a micro USB cable (to power the board) | Connect the JTAG J12 on board to the computer using a JTAG based debugger | . ",
    ...
    "doc": "FAT filesystem using SDMMC Media",
    "title": "Running the Application",
    "content": ". | Build and program the application using its IDE | The LED is turned ON if there was no error during creating the directory and copying the file into it | . Refer to the following table for LED name: . | Board | LED Name | . | SAM9X60-Curiosity board | RGB_LED(Green) | . |   |   | . ",
    ...
    "doc": "FAT filesystem throughput using SDMMC Media",
    "title": "Setting up the hardware",
    "content": "The following table shows the target hardware for the application projects. | Project Name | Board | . | sam_9x60_curiosity.X | SAM9X60-Curiosity board | . |   |   | . Setting up SAM9X60-Curiosity board . | Insert the SD card into SDMMC0 (J3) slot on the board (SD Card with FAT32 file system) . | The SD Card should have atleast 10MB of free space for the demo to work | . | Connect the USB port J1 on board to the computer using a micro USB cable (to power the board) | Connect the JTAG J12 on board to the computer using a JTAG based debugger | Connect the J11 on board to the computer using a UART-FTDI cable (to enable debug com port) | . ",
    ...
    "doc": "FAT filesystem throughput using SDMMC Media",
    "title": "Running the Application",
    "content": ". | Open the Terminal application (Ex.:Tera term) on the computer. | Connect to the COM port and configure the serial settings as follows: . | Baud : 115200 | Data : 8 Bits | Parity : None | Stop : 1 Bit | Flow Control : None | . | Build and program the application using its IDE | The LED is turned ON if there was no error during the file operations . Refer to the following table for LED name: . | Board | LED Name | . | SAM9X60-Curiosity board | RGB_LED(Green) | . |   |   | . | Calculated throughput values for Aligned and Un-Aligned buffers are dispalyed on console as below: . | Note: The Values showed in the below output may differ slightly when demo is run | . | . ",
    ...
    "doc": "FreeRTOS Task Notification",
    "title": "Running the Application",
    "content": ". | Build and program the application using its IDE | The LED toggles on success for every 500ms | . Refer to the following table for LED name: . | Board | LED Name | . | SAM9X60-Curiosity board | RGB_LED(Green) | . |   |   | . ",
    ...
    "url": "http://localhost:4000/core_apps_sam_9x60/apps/docs/readme_bootstrap.html#using-at91boostrap-loader-with-harmony3-mpu-applications",
    ...
    "url": "http://localhost:4000/core_apps_sam_9x60/apps/docs/readme_bootstrap.html#rundebug-mpu-applications-using-mplabx",
    ...
    "url": "http://localhost:4000/core_apps_sam_9x60/apps/docs/readme_bootstrap.html#boot-to-application-using-sd-card",
    ...
    "url": "http://localhost:4000/core_apps_sam_9x60/apps/docs/readme_bootstrap_build.html#building-at91bootstrap-project-using-mplabx",
    ...
    "url": "http://localhost:4000/core_apps_sam_9x60/apps/docs/readme_bootstrap_build.html#configure-compiler",
    "relUrl": "/apps/docs/readme_bootstrap_build.html#configure-compiler"
  },"141": {
    "doc": "Building AT91Bootstrap project using MPLABx",
    "title": "Configure target",
    "content": ". | Open project properties window, and choose “Kconfig” option to configure the build target: . | Click on “LOAD” button and navigate to the configs folder inside at91bootstrap.X directory. You need to choose the default configuration file(defconfig) based on what you need the at91boostrap to do . Debug/Run application from within MPLABx . | Load {evaluation_kit}_bkpt_none_defconfig. For example, on SAM9X60 Curiosity Board, select sam9x60_curiosity_bkptnone_defconfig as the configuration file . | Click on “Apply” and “OK” buttons to configure the project . | You can see that the MPU product is now selected as “SAM9X60” and the primary operation is selected as “Configure and Stop” . | . Load and Run application from an SD card . | Load {evaluation_kit}sd_uboot_defconfig. For example, on SAM9X60 Curiosity Board, select sam9x60_curiositysd_uboot_defconfig as the configuration file . | Click on “Apply” and “OK” buttons to configure the project . | You can see that the MPU product is now selected as “SAM9X60” and the primary operation is selected as “Load and launch next software” . | Edit the Option “Next Software Image File Name” from u-boot.bin to harmony.bin . | . | . ",
    "url": "http://localhost:4000/core_apps_sam_9x60/apps/docs/readme_bootstrap_build.html#configure-target",
    ...
    "url": "http://localhost:4000/core_apps_sam_9x60/apps/docs/readme_bootstrap_build.html#build-target",
    "relUrl": "/apps/docs/readme_bootstrap_build.html#build-target"
  },"143": {
    "doc": "Building AT91Bootstrap project using MPLABx",
    "title": "Building AT91Bootstrap project using MPLABx",
    "content": ". ",
    "url": "http://localhost:4000/core_apps_sam_9x60/apps/docs/readme_bootstrap_build.html",
    ...
    "doc": "Release notes",
    "title": "Harmony 3 peripheral library application examples for SAM9X60 family  v3.4.0",
    "content": "Development kit and demo application support . Following table provides number of peripheral library examples available for different development kits. | Development Kits | MPLAB X applications | . | SAM9X60 Curiosity Development Board | 27 | . New Features . | None | . Known Issues . | None | . Development Tools . | MPLAB® X IDE v6.05 | MPLAB® X IDE plug-ins: . | MPLAB® Code Configurator (MCC) v5.3.0 | . | MPLAB® XC32 C/C++ Compiler v4.21 | . ",
    "url": "http://localhost:4000/core_apps_sam_9x60/release_notes.html#harmony-3-peripheral-library-application-examples-for-sam9x60-family--v340",
    "relUrl": "/release_notes.html#harmony-3-peripheral-library-application-examples-for-sam9x60-family--v340"
  },"146": {
    "doc": "Release notes",
    "title": "Harmony 3 peripheral library application examples for SAM9X60 family  v3.3.0",
    "content": "Development kit and demo application support . Following table provides number of peripheral library examples available for different development kits. | Development Kits | MPLAB X applications | IAR applications | . | SAM9X60-EK Evaluation Kit | 31 | 27 | . New Features . | None | . Known Issues . | None | . Development Tools . | MPLAB® X IDE v6.00 | MPLAB® X IDE plug-ins: . | MPLAB® Code Configurator (MCC) v5.1.9 | . | MPLAB® XC32 C/C++ Compiler v4.10 | IAR Embedded workbench for ARM v9.10 or above | . ",
    "url": "http://localhost:4000/core_apps_sam_9x60/release_notes.html#harmony-3-peripheral-library-application-examples-for-sam9x60-family--v330",
    "relUrl": "/release_notes.html#harmony-3-peripheral-library-application-examples-for-sam9x60-family--v330"
  },"147": {
    "doc": "Release notes",
    ...
    "content": "Development kit and demo application support . Following table provides number of peripheral library examples available for different development kits. | Development Kits | MPLAB X applications | IAR applications | . | SAM9X60-EK Evaluation Kit | 30 | 27 | . New Features . | None | . Known Issues . | SAM9X60 family: SAM9X60_DFP v1.5.50 or higher is required to correctly program and debug the application from within MPLAB X 5.45 | . Development Tools . | MPLAB® X IDE v5.45 | MPLAB® X IDE plug-ins: . | MPLAB® Harmony Configurator (MHC) v3.7.0 | . | MPLAB® XC32 C/C++ Compiler v2.50 | IAR Embedded workbench for ARM v8.50 or above | . ",
