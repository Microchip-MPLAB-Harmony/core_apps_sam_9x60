...
| docs       | Contains documentation in html format for offline viewing (to be used only after cloning this repository onto a local machine). Use [github pages](https://microchip-mplab-harmony.github.io/core_apps_sam_9x60/) of this repository for viewing it online. |
...
| [SMC NAND Flash driver - NAND Flash Read Write](apps/driver/smc_flash/nand_flash/nand_flash_read_write/readme.md) | This example application shows how to use the NAND Flash driver to perform read and write operations on NAND Flash device |
